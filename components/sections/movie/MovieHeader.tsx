...
const MovieHeader = ({poster_path, title, runtime, release_date, genres, vote_average, image}: Props) => {
    ...
    return (
        <div className={styles["movie-header"]}>
            ...
            <div className={styles["movie-header__image"]}>
                <Image className={styles["poster-img"]} src={`${IMAGE_BASE_URL}/${poster_path}`} alt="up" fill sizes="100vw"></Image>
            </div>
